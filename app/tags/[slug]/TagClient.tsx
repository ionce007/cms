...
export default function TagClient({ slug, tagName }: TagClientProps) {
    ...
    useEffect(() => {
        console.log('[TagClient] mounted with props:', { slug, tagName });
    }, [slug, tagName]);
    ...
    useEffect(() => {
        ...
        fetchArticles();
    }, [slug, tagName, currentPage, sortBy]);  // ✅ 依赖增加 sortBy
    ...
    useEffect(() => {
        console.log('articles is loaded! ')
                ...
                <div className="bg-gradient-to-r from-primary-600 to-primary-800 text-white">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                <h1 className="text-3xl lg:text-4xl font-bold">{tagName}</h1>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                {articles.length > 0 ? (
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                {articles.map((article, index) => (
                                                    <ArticleCard
                                                        ...
                                                        article={article}
                                                        index={index}
                                                        linkPrefix={`/tags/${slug}/articles`}  // ✅ 关键
                                                    />
                                                ))}
                                            </div>
                                        ) : (
                                    ...
                                    <div className="text-center py-16">
                                        ...
                                        <p className="text-gray-600">该标签下还没有文章</p>
                                    </div>
                                )}
                            </div>
