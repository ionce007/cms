// components/frontend/TeamSection.tsx
                    ...
                    {members.map((member) => (
                        ...
                        >
                            ...
                            <div className="relative h-48 overflow-hidden">
                                ...
                                {/* 社交链接 */}
                                <div className="absolute bottom-3 left-0 right-0 flex justify-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    <a
                                        href={member.github}
                                        target="_blank"
