...
import { categories } from '@/data/frontendData';
...
export default function Header() {
    ...
    const navItems = [
        ...
        { label: '文章', href: '/articles', active: false },
        { label: '分类', href: '/categories', active: false },
        { label: '标签', href: '/tags', active: false },
                            ...
                            {isSearchOpen ? (
                                <div className="flex items-center">
                                    <input
                                        ...
                                        className="w-48 lg:w-56 px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                                        autoFocus
                                    />
                                    {searchTerm && (
                                        <button
